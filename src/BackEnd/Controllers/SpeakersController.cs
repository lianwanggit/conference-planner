...
namespace BackEnd.Controllers
{
    ...
    public class SpeakersController : Controller
    {
        ...
        [HttpGet]
        [Route("GetSpeakerBySlug/{slug}")]
        public async Task<IActionResult> GetSpeakerBySlug([FromRoute]string slug)
        {
            var speaker = await _db.Speakers.AsNoTracking()
                                        .Include(s => s.SessionSpeakers)
                                            .ThenInclude(ss => ss.Session)
        ...
        // POST: api/Speakers
        [HttpPost]
        public async Task<IActionResult> Post([FromBody]ConferenceDTO.Speaker input)
        {
